-- Run this migration after earlier Battle Royale migrations.
-- A Ready click persists immediately; the last Ready begins the synchronized
-- five second start. At the 15 second deadline, remaining players auto Ready.
...
begin
  ...
  if m.status<>'loading' then raise exception 'Round is not loading'; end if;
