...
if (typeof window !== 'undefined') {
  ...
  const addStyles=()=>{
    ...
    const style=document.createElement('style');style.id='ranked-result-colors';style.textContent=`
      ...
      .game>.realRankedLiveHud.rankedScoreboard>small{display:none!important}.game>.realRankedLiveHud.rankedScoreboard>div{display:flex!important;flex-direction:column!important;gap:5px!important;width:100%!important;min-width:0!important}.game>.realRankedLiveHud.rankedScoreboard i{display:none!important}
      .game>.realRankedLiveHud.rankedScoreboard span:has(.rrMe,.rrOpp){position:relative!important;display:grid!important;grid-template-columns:minmax(0,1fr) auto!important;grid-template-rows:auto auto!important;align-items:center!important;box-sizing:border-box!important;width:100%!important;height:45px!important;min-width:0!important;margin:0!important;padding:6px 8px 6px 25px!important;border-radius:10px!important;background:#0f131c!important;border:1px solid #303747!important;text-align:left!important;transform:none!important;box-shadow:none!important}.game>.realRankedLiveHud.rankedScoreboard span:has(.rrMe,.rrOpp):before{content:'#' attr(data-place);position:absolute;left:8px;top:50%;transform:translateY(-50%);font-size:10px;font-weight:1000;color:#7e8799}.game>.realRankedLiveHud.rankedScoreboard span[data-place='1']{border-color:#6f7685!important}.game>.realRankedLiveHud.rankedScoreboard span[data-place='1']:before{color:#ffd43b}
      .game>.realRankedLiveHud.rankedScoreboard span:has(.rrMe,.rrOpp)>b{grid-column:1;grid-row:1;font-size:10px!important;line-height:1.05!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;min-width:0!important}.game>.realRankedLiveHud.rankedScoreboard span:has(.rrMe,.rrOpp)>em{grid-column:1;grid-row:2;font-size:7px!important;line-height:1!important;color:#788195!important;font-style:normal!important;white-space:nowrap!important}.game>.realRankedLiveHud.rankedScoreboard .rrMe,.game>.realRankedLiveHud.rankedScoreboard .rrOpp{grid-column:2!important;grid-row:1 / span 2!important;font-size:14px!important;line-height:1!important;font-variant-numeric:tabular-nums;margin-left:5px!important;white-space:nowrap!important}.game>.realRankedLiveHud.rankedScoreboard .rrLiveExtra{display:none!important}
      @media(max-width:760px){.game>.realRankedLiveHud.rankedScoreboard{left:8px!important;bottom:292px!important;width:135px!important;max-width:135px!important}.game>.realRankedLiveHud.rankedScoreboard span:has(.rrMe,.rrOpp){height:42px!important}}
